...
import DonationHistory from "./pages/users/DonationHistory";
import DonorAvailableStatus from "./pages/users/DonorAvailableStatus";
import UserProfile from "./pages/users/UserProfile";
import UserBloodRequestList from "./pages/users/UserBloodRequestList";
import UserBloodRequestDetail from "./pages/users/UserBloodRequestDetail";
import BloodGroupLookup from "./pages/users/BloodGroupLookup";
import BloodCompatibilityLookup from "./pages/users/BloodCompatibilityLookup";
import DonationDetail from "./pages/users/DonationDetail";
    ...
    return (
        <Routes key={key}>
            ...
            >
                ...
                <Route
                    path="blood-requests"
                    element={<UserBloodRequestList />}
                />
                <Route
                    path="blood-request/:id"
                    element={<UserBloodRequestDetail />}
                />
                <Route path="donation-history" element={<DonationHistory />} />
                <Route
                    path="donor-available"
                    element={<DonorAvailableStatus />}
                />
                <Route path="profile" element={<UserProfile />} />
                <Route
                    path="blood-group-lookup"
                    element={<BloodGroupLookup />}
                />
                <Route
                    path="blood-compatibility-lookup"
                    element={<BloodCompatibilityLookup />}
                />
                <Route
