  ...
  return (
    <header className="doctor-header">
      ...
      <nav className="menu">
        ...
        <button onClick={() => handleNavigate("/doctor/donation")}>
          Donation
        </button>
        <button onClick={() => handleNavigate("/doctor/donor-available")}>
          Donor Available
        </button>
        <button onClick={() => handleNavigate("/doctor/request")}>
          Blood Request
        </button>
      </nav>
      ...
      >
        ...
        {showAccountMenu && (
          <div className="account-menu">
            <button onClick={() => handleNavigate("/doctor/profile")}>
              Thông tin
            </button>
